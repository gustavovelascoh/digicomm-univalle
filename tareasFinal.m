...
switch item
    case 1
        text = {'Calculadora','','Calculadora Ficticia para aprender a manejar el GUIDE'};
    case 2
        text = {'Codificación de Pulsos.'...
            ''...
            'Incluye las codificaciones:'...
            '* NRZ-L'...
            '* NRZ-M'...
            '* NRZ-S'...
            '* Unipolar RZ'...
    ...
    case 5
        text = {'Presupuesto de Enlace','','Calculadora para el presupuesto de enlace'};
    case 6
